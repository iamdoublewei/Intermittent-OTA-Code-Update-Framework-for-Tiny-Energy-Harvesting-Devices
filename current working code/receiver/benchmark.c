...
//{
//    // 8-bit Math
//    volatile UInt8 math_8[4];
//    math_8[0] = 12;
//    math_8[1] = 3;
//    math_8[2] = math_8[0] + math_8[1];
//    math_8[1] = math_8[0] * math_8[2];
//    math_8[3] = math_8[1] / math_8[2];
//
//    // float Math
//    volatile float math_float[4];
//    math_float[0] = 54.567;
//    math_float[1] = 14346.67;
//    math_float[2] = math_float[0] + math_float[1];
//    math_float[1] = math_float[0] * math_float[2];
//    math_float[3] = math_float[1] / math_float[2];
//
//    // 16-bit Math
//    volatile UInt16 math_16[4];
//    math_16[0] = 231;
//    math_16[1] = 12;
//    math_16[2] = math_16[0] + math_16[1];
//    math_16[1] = math_16[0] * math_16[2];
//    math_16[3] = math_16[1] / math_16[2];
//
//    // 32-bit Math
////    volatile UInt32 math_32[4];
////    math_32[0] = 43125;
////    math_32[1] = 14567;
////    math_32[2] = math_32[0] + math_32[1];
////    math_32[1] = math_32[0] * math_32[2];
////    math_32[3] = math_32[1] / math_32[2];
//    return;
//}
//
///*******************************************************************************
